          ...
          */}
            <div className="flex items-start justify-center gap-2 px-1 sm:gap-4 sm:px-4">
              <Link
                ...
                title="Slang Globe"
                className="group absolute left-3 top-[65%] z-20 flex shrink-0 -translate-y-1/2 flex-col items-center gap-0.5 transition-transform hover:scale-105 sm:left-4 sm:gap-1"
              >
              ...
              <Link
                ...
                title="Slang Arena"
                className="group absolute right-3 top-[65%] z-20 flex shrink-0 -translate-y-1/2 flex-col items-center gap-0.5 transition-transform hover:scale-105 sm:right-4 sm:gap-1"
              >
                <div className="grid h-11 w-11 place-items-center rounded-full border border-brand/60 bg-background/80 shadow-glow transition-colors group-hover:border-brand group-hover:bg-brand/10 sm:h-12 sm:w-12">
