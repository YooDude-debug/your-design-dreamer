...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      interaction_events: {
        Row: {
          ...
          category_id: string | null;
          content_id: string | null;
          content_type: Database["public"]["Enums"]["interest_content_type"] | null;
          created_at: string;
          dwell_ms: number;
          id: string;
          peer_id: string | null;
    ...
    Enums: {
      ...
      feedback_category: "bug" | "improvement" | "design" | "performance" | "other";
      ...
      market_promotion_type: "standard" | "featured" | "channel_boost" | "local_boost";
      market_refund_status: "requested" | "processing" | "completed" | "failed";
      market_shipping_status: "not_required" | "awaiting_shipment" | "shipped" | "delivered";
      ...
      slang_tag_unlock_type: "open" | "follow" | "challenge" | "event" | "premium";
