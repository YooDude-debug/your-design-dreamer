  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Y-Dude Market: listings, price offers, contact and pickup processes (sections 3b to 3k)",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Y-Dude is not the seller of the items offered and does not become a party to the purchase contract. The purchase contract is concluded exclusively between the listing user (seller) and the purchasing user (buyer). Y-Dude provides the technical infrastructure for listing, search, contact, price offers and documentation of the pickup process.",
        "Payment for Market purchases is not handled by Y-Dude. Buyer and seller agree the payment method directly between themselves.",
        "Listings are not checked for accuracy, authenticity, condition, marketability or lawfulness before publication. All details about the item, price, condition and location come from the seller.",
    ...
    },
    {
      ...
      paragraphs: [
        "Each listing shows the seller's user profile and the details entered by the seller: title, description, images, price, willingness to negotiate, condition as well as place and postal code area.",
    ...
    {
      title: "3d. Handling and prices in the Market",
      paragraphs: [
        "A process is documented as a transaction with its own reference number. It records the item price, quantity, total amount, currency and handover by pickup.",
        ...
        "Payment of the purchase price is not handled by Y-Dude. There is no payment process via the platform in the Market and no payment status for purchases managed by Y-Dude. Buyer and seller arrange the payment method and time themselves.",
        "Y-Dude does not hold purchase prices, does not forward payments and does not act as an escrow service.",
      ],
    },
    {
      title: "3e. Platform fee and promotion of listings",
      paragraphs: [
        "No platform fee is currently collected via the platform for Market processes, because the purchase price is not handled by Y-Dude. Fee items (platform fee, payment fee, seller share) can only be shown in a transaction for information.",
        "These Terms do not set fee rates; the fee settings can be changed by the operator and apply to processes created afterwards.",
        ...
        `Collection of platform fees, payout of a seller's share as well as invoicing for promotions are currently not implemented in an automated way: ${REVIEW_TECH_EN}`,
      ],
    },
    {
      title: "3f. Payment service provider and payment data",
      paragraphs: [
        "Payments for promotions of listings and for subscriptions are processed via Stripe. Purchase price payments in the Market do not run via Stripe and not via Y-Dude.",
        "In this respect Stripe acts as an independent payment service provider and processes payment data under its own terms and privacy notices (available at stripe.com).",
        "The details required for the payment process are transmitted to Stripe: amount, currency, package designation, process reference, customer identifier and email address.",
    ...
    {
      title: "3g. Pickup, shipping and completion",
      paragraphs: [
        "In the Market, handover generally takes place by pickup. The buyer receives a single-use pickup code for the process; place and time of handover are arranged by buyer and seller themselves.",
        "Y-Dude does not organise or handle any shipping. There is no shipping calculation, no shipping labels and no tracking via the platform.",
        "If buyer and seller nevertheless agree on shipping, they arrange the shipping method, carrier, costs, payment method, address and all further details directly between themselves.",
        "Confirming the handover in the transaction view serves traceability and does not replace statutory claims.",
    ...
    },
    {
      ...
      paragraphs: [
        "A process can be cancelled until handover; the listing is then released again.",
        "As the purchase price is not paid via Y-Dude, the platform cannot make or initiate a refund of a purchase price. Any reversal takes place directly between buyer and seller.",
        "Buyer and seller can report a dispute with reasons in the transaction view. Disputes are reviewed and decided by the operator; status and decision are logged.",
        "Refund records from earlier purchases paid via the platform remain stored as evidence and continue to be handled by the operator only.",
        "A decision by the operator in a dispute is an internal platform measure and does not replace statutory claims between buyer and seller.",
      ],
    },
    {
