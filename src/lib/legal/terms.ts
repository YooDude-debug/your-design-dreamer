  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Y-Dude Market: Inserate, Preisangebote, Kontaktaufnahme und Vorgänge zur Abholung (Abschnitte 3b bis 3j)",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Y-Dude ist nicht Verkäufer der angebotenen Artikel und wird nicht Vertragspartei des Kaufvertrags. Der Kaufvertrag kommt ausschließlich zwischen dem inserierenden Nutzer (Verkäufer) und dem kaufenden Nutzer (Käufer) zustande. Y-Dude stellt die technische Infrastruktur für Inserat, Suche, Kontaktaufnahme, Preisangebote und die Dokumentation des Abholvorgangs bereit.",
        "Die Zahlung für Market-Käufe wird nicht über Y-Dude abgewickelt. Käufer und Verkäufer vereinbaren die Zahlungsweise unmittelbar untereinander.",
        "Inserate werden vor Veröffentlichung nicht auf Richtigkeit, Echtheit, Zustand, Verkehrsfähigkeit oder Rechtmäßigkeit geprüft. Alle Angaben zu Artikel, Preis, Zustand und Ort stammen vom Verkäufer.",
    ...
    },
    {
      ...
      paragraphs: [
        "Zu jedem Inserat werden das Nutzerprofil des Verkäufers und die vom Verkäufer eingegebenen Angaben angezeigt: Titel, Beschreibung, Bilder, Preis, Verhandlungsbereitschaft, Zustand sowie Ort und Postleitzahlbereich.",
    ...
    {
      title: "3d. Abwicklung und Preise im Market",
      paragraphs: [
        "Der Vorgang wird als Transaktion mit eigener Referenznummer dokumentiert. Festgehalten werden Artikelpreis, Menge, Gesamtbetrag, Währung sowie die Übergabe durch Abholung.",
        "Preise legt der Verkäufer fest. Ist ein Artikel als verhandelbar gekennzeichnet, können Käufer ein Preisangebot abgeben; nimmt der Verkäufer es an, wird der vereinbarte Betrag in der Transaktion festgehalten.",
        "Die Zahlung des Kaufpreises wird nicht über Y-Dude abgewickelt. Es gibt im Market keinen Bezahlvorgang über die Plattform und keinen von Y-Dude verwalteten Zahlungsstatus für Käufe. Zahlungsweise und Zeitpunkt vereinbaren Käufer und Verkäufer selbst.",
        "Y-Dude verwahrt keine Kaufpreise, leitet keine Zahlungen weiter und übernimmt keine Treuhandfunktion.",
      ],
    },
    {
      title: "3e. Plattformgebühr und Hervorhebung von Inseraten",
      paragraphs: [
        "Für Vorgänge im Market wird derzeit keine Plattformgebühr über die Plattform eingezogen, weil der Kaufpreis nicht über Y-Dude abgewickelt wird. In der Transaktion können Gebührenpositionen (Plattformgebühr, Zahlungsgebühr, Verkäuferanteil) nur informatorisch ausgewiesen werden.",
        "Diese AGB legen keine Gebührensätze fest; die Gebühreneinstellungen können durch den Betreiber geändert werden und gelten für danach angelegte Vorgänge.",
        ...
        `Einzug von Plattformgebühren, Auszahlung eines Verkäuferanteils sowie Rechnungsstellung über Hervorhebungen sind derzeit nicht automatisiert umgesetzt: ${REVIEW_TECH}`,
      ],
    },
    {
      title: "3f. Zahlungsdienstleister und Zahlungsdaten",
      paragraphs: [
        "Zahlungen für Hervorhebungen von Inseraten und für Abonnements werden über Stripe abgewickelt. Kaufpreiszahlungen im Market laufen nicht über Stripe und nicht über Y-Dude.",
        "Stripe ist insoweit eigenverantwortlicher Zahlungsdienstleister und verarbeitet die Zahlungsdaten nach seinen eigenen Bedingungen und Datenschutzhinweisen (abrufbar unter stripe.com).",
        "An Stripe werden dabei die für den Bezahlvorgang erforderlichen Angaben übermittelt: Betrag, Währung, Bezeichnung des Pakets, Vorgangsreferenz, Kundenkennung und E-Mail-Adresse.",
    ...
    {
      title: "3g. Abholung, Versand und Abschluss",
      paragraphs: [
        "Die Übergabe erfolgt im Market grundsätzlich durch Abholung. Der Käufer erhält für den Vorgang einen einmalig verwendbaren Abholcode; Ort und Zeitpunkt der Übergabe vereinbaren Käufer und Verkäufer selbst.",
        "Y-Dude organisiert und wickelt keinen Versand ab. Es gibt keine Versandberechnung, keine Versandetiketten und keine Sendungsverfolgung über die Plattform.",
        "Vereinbaren Käufer und Verkäufer dennoch einen Versand, regeln sie Versandart, Versanddienstleister, Kosten, Zahlungsweise, Anschrift und alle weiteren Einzelheiten unmittelbar untereinander.",
        "Die Bestätigung der Übergabe in der Transaktionsansicht dient der Nachvollziehbarkeit und ersetzt keine gesetzlichen Ansprüche.",
    ...
    },
    {
      ...
      paragraphs: [
        "Ein Vorgang kann bis zur Übergabe abgebrochen werden; das Inserat wird dann wieder freigegeben.",
        "Da der Kaufpreis nicht über Y-Dude gezahlt wird, kann die Plattform keine Erstattung eines Kaufpreises vornehmen oder veranlassen. Eine Rückabwicklung erfolgt unmittelbar zwischen Käufer und Verkäufer.",
        "Käufer und Verkäufer können in der Transaktionsansicht einen Streitfall mit Begründung melden. Streitfälle werden vom Betreiber geprüft und entschieden; Status und Entscheidung werden protokolliert.",
        "Erstattungsvorgänge aus früheren, über die Plattform bezahlten Käufen bleiben als Nachweis gespeichert und werden weiterhin nur durch den Betreiber bearbeitet.",
        "Eine Entscheidung des Betreibers in einem Streitfall ist eine plattforminterne Maßnahme und ersetzt keine gesetzlichen Ansprüche zwischen Käufer und Verkäufer.",
      ],
    },
    {
