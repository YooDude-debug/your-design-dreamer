...
const de = {
  landing: {
    ...
    valueProp: "Entdecke Stimmen, Slang und Geschichten aus deiner Region und aus der ganzen Welt.",
    headlineA: "Das soziale Netzwerk für",
    headlineB: "Sprache, Slang & regionale Stimmen.",
    headlineSub: "Entdecke, wie deine Region klingt – und wie die Welt spricht.",
...
const en: AuthDict = {
  landing: {
    ...
    valueProp: "Discover voices, slang and stories from your region and around the world.",
    headlineA: "The social network for",
    headlineB: "Language, slang & regional voices.",
    headlineSub: "Discover how your region sounds – and how the world speaks.",
...
const el: AuthDict = {
  landing: {
    ...
    valueProp: "Ανακάλυψε φωνές, αργκό και ιστορίες από την περιοχή σου και όλο τον κόσμο.",
    headlineA: "Το κοινωνικό δίκτυο για",
    headlineB: "Γλώσσα, αργκό & τοπικές φωνές.",
    headlineSub: "Ανακάλυψε πώς ηχεί η περιοχή σου – και πώς μιλά ο κόσμος.",
    cta: "Μπες στο vibe",
  ...
  turnstile: {
    ...
    retry: "Επανεκκίνηση ελέγχου ασφαλείας",
    failed: (host: string) =>
