  ...
  // ── Europa: Deutschsprachiger Raum ─────────────────────────────────────
  {
    ...
    tags: [
      [
        ...
        "Freundschaft",
        "Kumpel, Alter",
        "Direkte Anrede unter Freunden, sehr verbreitet in der Jugendsprache.",
      ],
      [
        "sheesh",
        "Erstaunen",
        "Wow, krass",
        "Ausruf, wenn etwas beeindruckt oder übertrieben wirkt.",
      ],
      [
        "lauch",
        "Humor",
        "schwächlicher Typ",
        "Spöttisch für jemanden ohne Kraft oder Durchsetzung.",
      ],
    ],
  },
  {
    ...
    tags: [
      [
        ...
        "Norddeutscher Gruß, morgens wie abends verwendbar.",
      ],
  ...
  },
  {
    ...
    tags: [
      ...
      [
        ...
        "Zustimmung",
        "ist in Ordnung",
        "Entspannte Bestätigung, oft mit Achselzucken.",
      ],
    ],
  },
  {
    ...
    tags: [
      ...
      [
        ...
        "Kölsches Lebensmotto bei Problemen.",
      ],
    ],
  },
  {
  ...
  },
  {
    ...
    tags: [
      ...
      [
        ...
        "Regional",
        "Küchenschrank",
        "Klassisches Schibboleth des Schweizerdeutschen.",
      ],
  ...
  },
  {
    ...
    tags: [
      [
        "malaka",
        "Freundschaft",
        "Alter (derb, freundschaftlich)",
        "Unter Freunden extrem verbreitet.",
      ],
...
const FOOTBALL_ADDITIONS: Record<string, readonly TagRow[]> = {
  "DE|Dortmund": [
    [
      "echte-liebe",
      "Fußball",
      "echte Liebe (zum Verein)",
      "Fan-Bekenntnis zum eigenen Klub, unabhängig von Ergebnissen.",
    ],
  ...
  "DE|Berlin": [
    [
      ...
      "Fußball",
      "Auswärtsfahrt zum Pflichtspiel",
      "Ironisch für die feste Fan-Routine am Spieltag.",
    ],
  ],
  "DE|München": [
  ...
  "IT|Neapel": [["forza", "Fußball", "los, kämpft!", "Ruf von der Tribüne."]],
  "IT|Mailand": [
  ...
  "BR|Rio de Janeiro": [
    [
      ...
      "Ein Treffer, der auf eine Gedenktafel gehört.",
    ],
  ...
  "CO|Bogotá": [["hincha", "Fußball", "Fan", "Wer den Klub mit Herz begleitet."]],
  "MX|Mexiko-Stadt": [
    ["chilena", "Fußball", "Fallrückzieher", "Sehenswerter Torabschluss in der Luft."],
  ],
  "FR|Marseille": [["allez", "Fußball", "los geht's!", "Standardruf der französischen Kurven."]],
  "FR|Paris": [["lucarne", "Fußball", "Tor ins kurze Eck oben", "Treffer direkt unter die Latte."]],
  "NL|Amsterdam": [
    ["panna", "Fußball", "Tunnel im Straßenfußball", "Höchste Demütigung beim Eins-gegen-eins."],
  ],
  "TR|Istanbul": [["üçlük", "Fußball", "Dreierpack", "Drei Tore eines Spielers in einem Spiel."]],
  "GR|Athen": [["gkol", "Fußball", "Tor", "Jubelruf im Stadion."]],
  "EG|Kairo": [["goon", "Fußball", "Tor", "Ausruf beim Treffer in der Kurve."]],
  "NG|Lagos": [["baller", "Fußball", "starker Kicker", "Wer auf dem Platz überzeugt."]],
  "GH|Accra": [["gbeke", "Fußball", "Aufregung im Spiel", "Wenn eine Partie kippt."]],
  "SN|Dakar": [["tekki", "Fußball", "Dribbling", "Der Weg durch die Abwehr."]],
  "ZA|Johannesburg": [
  ...
  "JP|Tokio": [["sapo", "Fußball", "Supporter", "Kurzform für die Fanszene."]],
  "KR|Seoul": [
    ["daehanminguk", "Fußball", "Korea-Sprechchor", "Der Ruf der Nationalmannschafts-Fans."],
  ],
  "US|New York": [["footy", "Fußball", "Fußball (locker)", "Alltagswort für das Spiel."]],
};
...
const FOOTBALL_CITIES: readonly CityRow[] = [
  ...
  },
  {
    ...
    lng: -5.98,
    language: "Spanisch",
    tags: [["remontada", "Fußball", "Aufholjagd", "Rückstand noch in einen Sieg drehen."]],
  },
  {
    country: "Portugal",
    code: "PT",
    ...
    lng: -9.14,
    language: "Portugiesisch",
    tags: [["bicicleta", "Fußball", "Fallrückzieher", "Wörtlich „Fahrrad“ – Schuss in der Luft."]],
  },
  {
    country: "Uruguay",
    code: "UY",
    ...
    tags: [
      [
        ...
        "Nationales Fußball-Selbstbild Uruguays.",
      ],
    ],
  },
  {
