/**
 * Gemeinsamer Zugang zum Zahlungsanbieter (nur Server).
 *
 * Alle Aufrufe laufen über das Lovable-Connector-Gateway; echte
 * Anbieter-Schlüssel liegen nie im Projektcode. Es werden ausschließlich
 * Anbieter-Referenzen verarbeitet – niemals Karten- oder Bankdaten.
 */
...
/** Webhook-Signatur prüfen (HMAC-SHA256, ohne SDK). */
