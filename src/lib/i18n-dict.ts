...
const de = {
  ...
  tagFixed: "Fixiert",
  tagFollowFace: "Gesicht folgen",
  faceTapHint: "Tippe im Video auf das Gesicht, dem der SlangTag folgen soll.",
  faceTracking: "Gesicht wird verfolgt …",
  faceFollowActive: "SlangTag folgt dem Gesicht.",
  faceTrackFailed: "Kein Gesicht erkannt – SlangTag bleibt fixiert.",
  ...
  msgSendingPending: "Wird gesendet …",
  msgRetrying: "Erneuter Versuch …",
...
const en: Dict = {
  ...
  tagFixed: "Fixed",
  tagFollowFace: "Follow face",
  faceTapHint: "Tap the face in the video the SlangTag should follow.",
  faceTracking: "Tracking face …",
  faceFollowActive: "SlangTag follows the face.",
  faceTrackFailed: "No face detected – SlangTag stays fixed.",
  ...
  msgSendingPending: "Sending …",
  msgRetrying: "Retrying …",
...
const el: Dict = {
  ...
  tagFixed: "Σταθερό",
  tagFollowFace: "Ακολούθησε πρόσωπο",
  faceTapHint: "Πάτα στο πρόσωπο στο βίντεο που θα ακολουθεί το SlangTag.",
  faceTracking: "Παρακολούθηση προσώπου …",
  faceFollowActive: "Το SlangTag ακολουθεί το πρόσωπο.",
  faceTrackFailed: "Δεν εντοπίστηκε πρόσωπο – το SlangTag μένει σταθερό.",
  ...
  msgSendingPending: "Αποστέλλεται …",
  msgRetrying: "Νέα προσπάθεια …",
