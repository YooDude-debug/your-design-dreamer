...
const VOICES = [
  {
    file: "ronja-de.mp3",
    input: "Alles Gute, Ronja!",
    voice: "ash",
    instructions: CASUAL + " Casual German, Berlin tone, cheerful.",
    speed: 1.0,
  },
  {
    file: "ronja-en.mp3",
    ...
    voice: "alloy",
    instructions: CASUAL + " European English speaker, bright and excited.",
    speed: 1.05,
  },
  {
    file: "ronja-us.mp3",
    ...
    instructions:
      CASUAL +
      " German spoken with a noticeable American English accent, amused, a bit clumsy but loving.",
    speed: 0.98,
  },
  {
    file: "ronja-jp.mp3",
    input: "ロンヤ、お誕生日おめでとう！",
    voice: "sage",
    instructions: CASUAL + " Natural Japanese, friendly and warm.",
    speed: 1.0,
  },
];
