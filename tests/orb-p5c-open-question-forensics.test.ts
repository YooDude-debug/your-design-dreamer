...
describe("P5-C Forensik: Confirmation vs. offene Frage", () => {
  it("Klassifikation der Fälle A–E", () => {
    const rows = [
      ...
      "Ja.",
      "Das stimmt.",
      "Stimmt, ich habe eine RTX 5070.",
      "Ich habe eine RTX 5070.",
    ].map((t) => ({
      t,
      kind: utteranceKind(t),
      storable: isStorableStatement(t),
      signal: detectConfirmationSignal(t),
      askMe: isAskMeRequest(t),
      correction: isCorrection(t),
    }));
